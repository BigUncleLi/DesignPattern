...
public class Client {
    ...
    public void setUp() throws Exception {
        Class.forName("com.lizbyu.creational.factory.simple.register.instance.ConcreteProductA");
        Class.forName("com.lizbyu.creational.factory.simple.register.instance.ConcreteProductB");
    }
